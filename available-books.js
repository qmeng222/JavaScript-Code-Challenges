...
class Book {
  // NOTE: all book-related bode lives inside the book class (encapsulation)
  ...
  // use a getter function to retrieve a book's availability instead of calling book.getAvailability():
  get availability() {
